...
const CATALOG = [
  ...
  { kind: "neg-gold", icon: "fa-solid fa-ban", name: "You're Out!", how: "Top 3 del equipo en outs totales esta temporada (ponche, rodado, elevado, línea, base, regla y sacrificio).", match: (l) => l === "You're Out!" },
  { kind: "neg-gold", icon: "fa-solid fa-parachute-box", name: "Air Drop", how: "Top 3 del equipo en outs por elevado esta temporada.", match: (l) => l === "Air Drop" },
