...
const CATALOG = [
  ...
  { kind: "trajectory", icon: "fa-solid fa-pencil", name: "Manager", how: "Manager del equipo.", match: (l) => l === "Manager" },
  // ---- Racha ----
  ...
  { kind: "streak", icon: "fa-solid fa-snowflake", name: "Ice Cold", how: "Racha activa de 2 o más juegos seguidos sin hit.", match: (l) => l === "Ice Cold" },
  ...
  { kind: "gold", icon: "fa-solid fa-rocket", name: "Rocket", how: "Top 3 del equipo en carreras anotadas esta temporada.", match: (l) => l === "Rocket" },
  { kind: "neg-gold", icon: "fa-solid fa-beer-mug-empty", name: "Bartender", how: "Top 3 del equipo en ponches de bateo esta temporada.", match: (l) => l === "Bartender" },
  ...
  { kind: "neg-gold", icon: "fa-solid fa-explosion", name: "Wild Thing", how: "Top 3 del equipo en bases por bolas otorgadas (pitcheo) esta temporada.", match: (l) => l === "Wild Thing" },
  { kind: "neg-gold", icon: "fa-solid fa-baseball", name: "Gopher Ball", how: "Top 3 del equipo en jonrones permitidos (pitcheo) esta temporada.", match: (l) => l === "Gopher Ball" },
  ...
  { kind: "gold", icon: "fa-solid fa-jet-fighter-up", name: "Wingman", how: "Top 3 del equipo en asistencias (de out) esta temporada.", match: (l) => l === "Wingman" },
