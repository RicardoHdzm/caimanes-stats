...
//     ],
//     // Cómo lo sacaron, más allá del ponche (SO, que ya cuenta en batting) —
//     // tabla propia porque no todo out es al bat (BO/RO pueden pasar en
...
//     // Ya no hay campo `mvp` aquí — el MVP de cada juego (y de la
//     // temporada, medalla "Starboy") sale solo del voto del equipo en
//     // Supabase (mvp_votes), no se captura a mano.
//   },
// ];
export const GAMES = [
  {
  ...
  },
  {
    ...
    outs: [
      ...
      { playerId: "p7", GO: 0, FO: 5, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p5", GO: 0, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p12", GO: 0, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 1 },
      { playerId: "p20", GO: 0, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 1 },
      { playerId: "p4", GO: 1, FO: 2, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p15", GO: 1, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p13", GO: 0, FO: 3, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p8", GO: 0, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 1 },
      { playerId: "p11", GO: 1, FO: 0, LO: 0, BO: 1, RO: 0, SAC: 0 },
      { playerId: "p17", GO: 0, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
    ],
    substitutions: [
    ...
    outs: [
      { playerId: "p6", GO: 2, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p10", GO: 1, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p19", GO: 0, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p12", GO: 0, FO: 1, LO: 0, BO: 2, RO: 0, SAC: 0 },
      { playerId: "p7", GO: 0, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p3", GO: 0, FO: 1, LO: 0, BO: 1, RO: 0, SAC: 0 },
      { playerId: "p4", GO: 0, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p15", GO: 0, FO: 1, LO: 1, BO: 1, RO: 0, SAC: 0 },
      { playerId: "p17", GO: 1, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p16", GO: 0, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p14", GO: 1, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
    ],
    substitutions: [
    ...
    // Reemplaza el bloque completo del juego "g8" en GAMES por esto:
  {
    ...
    outs: [
      ...
      { playerId: "p10", GO: 0, FO: 1, LO: 0, BO: 1, RO: 0, SAC: 0 },
      { playerId: "p5", GO: 0, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p9", GO: 1, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p3", GO: 0, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p4", GO: 1, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p15", GO: 0, FO: 0, LO: 0, BO: 1, RO: 1, SAC: 0 },
      { playerId: "p13", GO: 0, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p17", GO: 1, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p11", GO: 1, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
        ...
        // Reemplaza el bloque completo del juego "g9" en GAMES por esto:
  {
    ...
    scoreThem: 17,
    batting: [
      { playerId: "p18", order: 1, position: "SS", AB: 3, H: 2, "2B": 1, "3B": 0, HR: 0, HRC: 0, RBI: 0, R: 2, BB: 0, SO: 0, SB: 1 },
      { playerId: "p5", order: 2, position: "CF", AB: 5, H: 3, "2B": 1, "3B": 0, HR: 0, HRC: 0, RBI: 2, R: 3, BB: 0, SO: 0, SB: 2 },
      { playerId: "p10", order: 3, position: "LF", AB: 5, H: 3, "2B": 0, "3B": 0, HR: 0, HRC: 0, RBI: 2, R: 1, BB: 0, SO: 0, SB: 3 },
      { playerId: "p12", order: 4, position: "1B", AB: 5, H: 3, "2B": 2, "3B": 0, HR: 0, HRC: 0, RBI: 2, R: 2, BB: 0, SO: 0, SB: 1 },
      { playerId: "p3", order: 5, position: "2B", AB: 4, H: 1, "2B": 0, "3B": 0, HR: 0, HRC: 0, RBI: 1, R: 2, BB: 1, SO: 0, SB: 2 },
      { playerId: "p8", order: 6, position: "JC", AB: 4, H: 3, "2B": 0, "3B": 0, HR: 0, HRC: 0, RBI: 0, R: 2, BB: 0, SO: 0, SB: 1 },
      { playerId: "p15", order: 7, position: "3B", AB: 3, H: 2, "2B": 1, "3B": 0, HR: 0, HRC: 0, RBI: 3, R: 2, BB: 1, SO: 0, SB: 0 },
      { playerId: "p7", order: 8, position: "RF", AB: 1, H: 0, "2B": 0, "3B": 0, HR: 0, HRC: 0, RBI: 0, R: 0, BB: 0, SO: 0, SB: 0 },
      { playerId: "p6", order: 9, position: "C", AB: 4, H: 3, "2B": 1, "3B": 0, HR: 0, HRC: 0, RBI: 3, R: 1, BB: 0, SO: 0, SB: 0 },
      { playerId: "p9", order: 10, position: "JD", AB: 4, H: 1, "2B": 0, "3B": 0, HR: 0, HRC: 0, RBI: 1, R: 1, BB: 0, SO: 0, SB: 0 },
      { playerId: "p13", order: 8, position: "RF", AB: 3, H: 2, "2B": 1, "3B": 1, HR: 0, HRC: 0, RBI: 2, R: 2, BB: 0, SO: 0, SB: 0 },
    ...
    outs: [
      ...
      { playerId: "p5", GO: 1, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p10", GO: 1, FO: 0, LO: 0, BO: 1, RO: 1, SAC: 0 },
      { playerId: "p12", GO: 0, FO: 2, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p3", GO: 1, FO: 2, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p8", GO: 0, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p15", GO: 1, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p7", GO: 1, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p6", GO: 1, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p9", GO: 2, FO: 1, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p13", GO: 1, FO: 0, LO: 0, BO: 0, RO: 0, SAC: 0 },
      { playerId: "p1", GO: 0, FO: 0, LO: 0, BO: 1, RO: 0, SAC: 0 },
    ],
    substitutions: [
